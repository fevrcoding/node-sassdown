...
// ======================
var Sassdown = function Sassdown(files, outdir, options) {
...
_.extend(Sassdown.prototype, {
    ...
    scaffold: function () {
        ...
        require('mkdirp').sync(this.config.root);
    },
    ...
    getData: function (file) {
        return {
            ...
            href: path.relative(this.config.root, file.src.replace(path.extname(file.src), '.html')),
            dest: file.src.replace(path.extname(file.src), '.html'),
            src: file.src
        };
    },
    ...
    tree: function () {
        ...
        this.config.tree = this.recurse(process.cwd());
